...
def save_annotated_frame(frame_b64: str, bounding_boxes: Iterable[Mapping[str, float]], output_path: str) -> str:
    ...
    for bbox in bounding_boxes:
        ...
        cv2.putText(frame, f"person {confidence:.2f}", (x1, max(20, y1 - 10)), cv2.FONT_HERSHEY_SIMPLEX, 0.5, (0, 0, 255), 1)
    cv2.putText(frame, f'count={count}', (20, 30), cv2.FONT_HERSHEY_SIMPLEX, 1.0, (0, 0, 0), 2)
